...
$messages['pms'] = array(
	...
	'semanticformsinputs-datepicker-dateformat' => 'La stringa ëd formà data. Varda la [http://www.mediawiki.org/w/index.php?title=Extension:Semantic_Forms_Inputs&fromsection=Date_picker#Parameters documentassion an linia] për savèjne ëd pi.',
	'semanticformsinputs-datepicker-weekstart' => 'Ël prim di dla sman-a (0 - Dumìnica, 1 - Lùn-es, ...).',
	'semanticformsinputs-datepicker-firstdate' => "La prima data ch'a peul esse sërnùa (an formà yyy/mm/dd).",
	'semanticformsinputs-datepicker-lastdate' => "L'ùltima data ch'a peul esse sërnùa (an formà yyy/mm/dd).",
	...
	'semanticformsinputs-datepicker-disabledates' => "Na lista separà da vìrgole d'antërvaj ëd date disabilità (date an formà yyyy/mm/dd, antërvaj an formà yyyy/mm/dd-yyyy/mm/dd).",
	'semanticformsinputs-datepicker-highlightdates' => "Na lista separà da vìrgole d'antvrvaj ëd date ch'a apariran evidensià (date an formà yyyy/mm/dd, antërvaj an formà yyyy/mm/dd-yyyy/mm/dd).",
	'semanticformsinputs-datepicker-showweeknumbers' => 'Ij nùmer dla sman-a a deuvo esse mostà a snista dla sman-a?',
	'semanticformsinputs-datepicker-enableinputfield' => "L'utent a deuv podèj venpe ël camp d'anseriment diretament o mach con la selession ëd data?",
	'semanticformsinputs-datepicker-showresetbutton' => "Un boton ëd anulament a deuv esse mostà? Sòn a l'é la sola manera për l'utent d'anulé ël camp d'anseriment se a l'é disabilità l'anseriment diret.",
	'semanticformsinputs-timepicker-mintime' => 'Ël prim temp da mosté. Formà: hh:mm',
	'semanticformsinputs-timepicker-maxtime' => "L'ùltim temp da mosté. Formà: hh:mm",
	'semanticformsinputs-timepicker-interval' => 'Antërvaj tra minute. Nùmer tra 1 e 60.',
	'semanticformsinputs-timepicker-enableinputfield' => "L'utent a deuv podèj venpe ël camp d'anseriment diretament o mach con la selession ëd data?",
	'semanticformsinputs-timepicker-showresetbutton' => "Un boton ëd anulament a deuv esse mostà? Sòn a l'é la sola manera për l'utent d'anulé ël camp d'anseriment se a l'é disabilità l'anseriment diret.",
	'semanticformsinputs-regexp-regexp' => 'L\'espression regolare l\'anseriment a deuv corisponde për esse bon. Sòn a deuv esse dàit compèis jë slash! Predefinì a "/.*/", visadì minca valor.',
	'semanticformsinputs-regexp-basetype' => "La sòrt base da dovré. A peul esse minca sòrt d'anseriment ch'a génera n'element ëd forma html o anseriment ëd sòrt o selession (visadì test, lista, selession) o n'àutra regexp. Predefinì a \"test\".",
	'semanticformsinputs-regexp-baseprefix' => 'Prefiss për ël paràmetr dla sòrt base.',
	'semanticformsinputs-regexp-orchar' => 'Ël caràter OR da dovré ant n\'espression regolar nopà che |. Predefinì a "!"',
	'semanticformsinputs-regexp-inverse' => "Se ampostà, l'anseriment a deuv NEN corisponde a l'espression regolar për esse bon. Visadì l'espression regolar a l'é anvërtìa.",
	'semanticformsinputs-regexp-message' => 'Ël mëssagi d\'eror da mosté se ël confront a faliss. Predefinì a "Formà gram!" (o equivalent ant la lenga local)',
	'semanticformsinputs-menuselect-structure' => "La strutura ëd menù a l'é na lista pa ordinà.",
	'semanticformsinputs-menuselect-enableinputfield' => "L'utent a deuv podèj vempe ël camp d'anseriment diretament?",
);
